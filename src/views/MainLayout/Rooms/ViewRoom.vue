<template>
  ...
  <div class="p-6 min-h-screen dark:bg-gray-900">
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-extrabold text-gray-800 dark:text-white">Xonalar ro'yxati: {{rooms.length}}ta</h1>
      <button
    ...
    <div class="overflow-x-auto shadow-xl rounded-lg">
      <table class="w-full bg-white dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-300">
        ...
        >
          ...
          <td class="px-6 py-2 font-semibold text-gray-800 dark:text-white">{{ room.name }}</td>
          <td class="px-6 py-2 font-semibold">{{ room.quantity }}</td>
          <td class="px-6 py-2 font-semibold">{{ room.description }}</td>
          <td class="px-6 py-2">
