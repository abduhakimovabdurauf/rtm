    ...
    <div class="overflow-x-auto shadow-xl rounded-lg">
      <table class="w-full bg-white dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-300">
        ...
        >
          ...
          <td class="px-6 py-2 font-semibold text-gray-800 dark:text-white" v-if="Task && Task.title">{{ Task.title }}</td>
          <td class="px-6 py-2 font-semibold" v-if="Task && Task.text">
            {{ Task.text.length > 20 ? Task.text.slice(0, 20) + '...' : Task.text }}
          </td>
          <td class="px-6 py-2 font-semibold" v-if="Task && Task.deadline">
            {{ Task.deadline }}
          </td>
          <td class="px-6 py-2">
